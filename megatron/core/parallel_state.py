        ...
        if pipeline_model_parallel_comm_backend != "ucc":
            ...
            if rank in ranks:
                if _PP_P2P_FWD_EVEN_SEND_ODD_RECV_GROUP is None:
                    ...
                    _PP_P2P_FWD_EVEN_SEND_ODD_RECV_GROUP = [
                        _PP_P2P_FWD_EVEN_SEND_ODD_RECV_GROUP,
                        fwd_even_send_odd_recv_group,
                    ]
                    _PP_P2P_FWD_EVEN_RECV_ODD_SEND_GROUP = [
                        _PP_P2P_FWD_EVEN_RECV_ODD_SEND_GROUP,
                        fwd_even_recv_odd_send_group,
                    ]
                    _PP_P2P_BWD_EVEN_SEND_ODD_RECV_GROUP = [
                        _PP_P2P_BWD_EVEN_SEND_ODD_RECV_GROUP,
                        bwd_even_send_odd_recv_group,
                    ]
                    _PP_P2P_BWD_EVEN_RECV_ODD_SEND_GROUP = [
                        _PP_P2P_BWD_EVEN_RECV_ODD_SEND_GROUP,
                        bwd_even_recv_odd_send_group,
                    ]
